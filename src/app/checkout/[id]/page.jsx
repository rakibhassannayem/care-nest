...
const CheckoutPage = ({ params }) => {
  ...
  const rate = bookingType === "hourly" ? service.hourlyRate : service.dailyRate;
  ...
  const handleConfirm = () => {
    // Logic for confirming booking could be added here
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="flex gap-6 mb-8">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="font-medium">Hourly (৳{service.hourlyRate}/hr)</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="radio"
                  ...
                  />
                  <span className="font-medium">Daily (৳{service.dailyRate}/day)</span>
                </label>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-600 mb-2">
                  {bookingType === "hourly" ? "Number of Hours" : "Number of Days"}
                </label>
                <input
                  type="number"
                  min="1"
          ...
          <div className="w-full lg:w-100">
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-100 sticky top-10">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center text-gray-600">
                  <span>Duration</span>
                  <span className="font-semibold text-gray-800">{duration} {bookingType === "hourly" ? "Hour(s)" : "Day(s)"}</span>
                </div>
                <div className="flex justify-between items-center text-gray-600">
                  <span>Rate</span>
                  <span className="font-semibold text-gray-800">৳{rate}/{bookingType === "hourly" ? "hr" : "day"}</span>
                </div>
              </div>
